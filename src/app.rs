...
impl App {
    ...
    pub fn restore_pci_selections(&mut self) -> usize {
        ...
        // Baseline reflects what the script actually contains; siblings
        // auto-added below then register as unsaved changes, so the exit
        // prompt (#52) offers to persist them.
